...

{
	...
	ok($items[0]->raw_item, "iThis is a Gopher menu.\t\t\t"); # 8
	...
	ok($items[1]->raw_item, "1Item one\t/directory\tlocalhost\t70"); # 27
	...
	ok($items[3]->raw_item, "0Item three\t/three.txt\tlocalhost\t70"); # 65
	...
	ok($items[5]->raw_item, "iDownload this:\t\t\t"); # 103
	...
	ok($items[6]->raw_item, "gGIF image\t/image.gif\tlocalhost\t70"); # 122
	...
	ok($items[7]->raw_item, "0Item six\t/six.txt\tlocalhost\t70"); # 141
...

	{
		...
		ok($of_types[1]->raw_item, "iDownload this:\t\t\t"); # 169
...

	{
		...
		ok($of_types[2]->raw_item, "iDownload this:\t\t\t"); # 194
...

	{
		...
		ok($except_types[2]->raw_item, "iDownload this:\t\t\t"); # 227
...

{
	...
	ok($items[1]->raw_item, "icontaining a + or ? character.\t\t\t"); # 298
	...
	ok($items[5]->raw_item, "iFill out this form:\t\t\t"); # 374
...

	{
		...
		ok($of_types[2]->raw_item, "iFill out this form:\t\t\t"); # 429
...

	{
		...
		ok($of_types[4]->raw_item, "iFill out this form:\t\t\t"); # 470
